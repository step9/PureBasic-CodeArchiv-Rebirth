...
; maintained by Little John, 2017-03-08
...
DeclareModule VectorIcons
   ...
   ; some extended CSS3 colors, marked as 'CSS3_' instead of 'CSS_' from the standard set
   ...
   Declare.i Filter (file$, img.i, size.i, color.i)
   ...
   Declare.i BlackPawn (file$, img.i, size.i, color.i)
   ...
   Declare.i UnFold (file$, img, size, color1.i, color2.i, rotation.d= 0, spatial.i=0)
   Declare.i Fold (file$, img, size, color1.i, color2.i, rotation.d= 0, spatial.i=0)
   ...
   Declare.i Compare (file$, img, size, color1.i, color2.i)
...
Module VectorIcons
   ...
   #Background = #PB_Image_Transparent   ; For debugging, use $00FFFF (yellow) or any other RGB color,
                                         ; so that you can see the border of your image.
   ...
   Macro DrawPen (_x_, _y_, _size_, _color1_, _color2_)
      ...
      ; _size_  : width and height
      ; [original code by Omi, transmogrified into a macro by Little John]
   ...
   Procedure.i Filter (file$, img.i, size.i, color.i)
      ; in : file$: name of SVG file which is to be created (only supported on Linux),
      ;             or "" for creating an image in memory
      ;      img  : number of the image which is to be created, or #PB_Any
      ;      size : width and height (number of pixels)
   ...
   Procedure.i BlackPawn (file$, img.i, size.i, color.i)
      ; in : file$: name of SVG file which is to be created (only supported on Linux),
      ;             or "" for creating an image in memory
      ;      img  : number of the image which is to be created, or #PB_Any
      ;      size : width and height (number of pixels)
   ...
   ;---------------------------------------------------------------
   ; Macros by Omi which are used in several of his icon procedures.
   ...
   Procedure.i Undo (file$, img.i, size.i, color.i, flipVertically.i=#False)
      ...
      ; out: return value: if img = #Pb_Any --> number of the created image,
      ;                    on error --> 0
      ; [org. by Omi, extended by Little John]
      Protected ret.i
      Protected p.d  = size / 32
      Protected p8.d = size / 8
      Protected p4.d = size / 4
   ...
   Procedure.i Unfold (file$, img, size, color1.i, color2.i, rotation.d= 0, spatial.i=0)
      ; in : file$: name of SVG file which is to be created (only supported on Linux),
      ;             or "" for creating an image in memory
      ;      img    : number of the image which is to be created, or #PB_Any
      ;      size   : width and height (number of pixels)
   ...
   Procedure.i Fold (file$, img, size, color1.i, color2.i, rotation.d= 0, spatial.i=0)
      ; in : file$: name of SVG file which is to be created (only supported on Linux),
      ;             or "" for creating an image in memory
      ;      img   : number of the image which is to be created, or #PB_Any
      ;      size  : width and height (number of pixels)
   ...
   Procedure.i BracketRound (file$, img, size, color.i, Open=#False)
      ; in : file$: name of SVG file which is to be created (only supported on Linux),
      ;             or "" for creating an image in memory
      ;      img  : number of the image which is to be created, or #PB_Any
      ;      size : width and height (number of pixels)
   ...
   Procedure.i BracketSquare (file$, img, size, color.i, Open=#False)
      ; in : file$: name of SVG file which is to be created (only supported on Linux),
      ;             or "" for creating an image in memory
      ;      img  : number of the image which is to be created, or #PB_Any
      ;      size : width and height (number of pixels)
   ...
   Procedure.i BracketAngle (file$, img, size, color.i, Open=#False)
      ; in : file$: name of SVG file which is to be created (only supported on Linux),
      ;             or "" for creating an image in memory
      ;      img  : number of the image which is to be created, or #PB_Any
      ;      size : width and height (number of pixels)
   ...
   Procedure.i BracketCurly (file$, img, size, color.i, Open=#False)
      ; in : file$: name of SVG file which is to be created (only supported on Linux),
      ;             or "" for creating an image in memory
      ;      img  : number of the image which is to be created, or #PB_Any
      ;      size : width and height (number of pixels)
   ...
   Procedure.i BracketHtml (file$, img, size, color.i, Open=#False)
      ; in : file$: name of SVG file which is to be created (only supported on Linux),
      ;             or "" for creating an image in memory
      ;      img  : number of the image which is to be created, or #PB_Any
      ;      size : width and height (number of pixels)
   ...
   Procedure.i Compare (file$, img, size, color1.i, color2.i)
      ; in : file$: name of SVG file which is to be created (only supported on Linux),
      ;             or "" for creating an image in memory
      ;      img   : number of the image which is to be created, or #PB_Any
      ;      size  : width and height (number of pixels)
   ...
   Procedure.i DrawVEllipseSegment (file$, img.i, size.i, color1.i, color2.i, color3.i=0, color4.i=0)
      ...
      If ret
         ...
         For i = 0 To 3 Step 3
            ...
            StrokePath    (p16)
            VectorSourceColor (colorTemp1)
            AddPathEllipse (p * 18 - offs, p * 18 - offs, p * 10, p * 7, 315, 225)    ; TODO: Has to be recalced after 5.43 update.
            StrokePath     (p16)
            colorTemp1 = color1
            colorTemp2 = color2
         Next i
   ...
   Procedure.i SetVColorSelect (file$, img.i, size.i, color1.i, color2.i, color3.i, color4.i=0, color5.i=0)
      ...
      If ret
         ...
         For i = 0 To 3 Step 3
            ...
            Until y > 24
            AddPathBox (p * 24    - offs, p * Y          - offs, p * 2.25, p * 2.25)
            AddPathBox (p * 26.25 - offs, p * (Y + 2.25) - offs, p * 2.25, p * 1)
            FillPath   ()
            colorTemp1 = color1
            colorTemp2 = color2
            colorTemp3 = color3
   ...
   Macro DrawMagnifyingGlass_Spatial (_x_, _y_, _size_, _reflection_=#False)
      ...
      ; _size_      : width and height
      ; _reflection_: #True / #False
      ; [by Little John, spatialized by Omi]
