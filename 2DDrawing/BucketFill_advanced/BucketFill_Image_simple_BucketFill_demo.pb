...
result=BF(-2, background_ID, texture_ID) ; Full size output, not more settings needed
...
path$=#Caisse
texture_ID=LoadImage(#PB_Any, path$)
result=BF(-50, background_ID, texture_ID,
                            40,
                            10)
ErrorCheck_BF(result)
...
texture_ID=LoadImage(#PB_Any, path$)
result=BF(-2, background_ID, texture_ID,
                            185, ; Get a color point for replacing with bucket fill x
                            100) ; y
ErrorCheck_BF(result)
...
result=BF(-2, background_ID, texture_ID,
                            300, 
                            280,
                            0, ; All zeros to default
                            0,
                            0,
                            0,
                            0,
                            0,
                            30, ; Reduce texture width
                            30) ; Reduce texture height
ErrorCheck_BF(result)
