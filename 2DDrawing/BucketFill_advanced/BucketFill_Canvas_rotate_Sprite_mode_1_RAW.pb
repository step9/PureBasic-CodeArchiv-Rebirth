...
Get_animation_buffer_background_ID_canvas_BF()
...
Repeat
  ...
  If Delay_BF(0, 20) ; Timer 0 - 100 timer available 0 - 99 - you can change
    ...
    RotateSprite_BF(texture_2_ID,
                                       ...
                                       70,  ; Rotating offset x - For mode 1 - Handle with care - Do not make offsets too big - I will give you not a limit
    ...
    ; - Call function #2 -
    result=BF(1, Get_animation_buffer_hidden_ID_canvas_BF(), texture_2_ID,
                                 0,   
                                 0,  
                                 -50+GetSprite_X_BF(),    ; Output x - Adjust rotation
                                 -80+GetSprite_Y_BF(),    ; Output y - Adjust rotation
                                 GetSprite_width_BF()+6,  ; Adjust rotation
                                 GetSprite_height_BF()+6, ; Adjust rotation
                                 GetSprite_X_BF()-3,      ; Adjust rotation
                                 GetSprite_Y_BF()-3)      ; Adjust rotation
    ErrorCheck_BF(result)
