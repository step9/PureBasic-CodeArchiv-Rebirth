...
Define Cat_01$="./BucketFill_Image_Set/Cat_01.jpg"
...
ResizeImage(texture_1_ID, 300, 260)
...
Repeat
  ...
  If Delay_BF(0, 20) ; Timer 0 - 100 timer available 0 - 99 - you can change
    ...
    RotateSprite_BF(texture_2_ID,
                                       -1,    ; Grab transparence color from sprite pos x - For preset set ..x=-1 - For ignore set ..x=-2                         
                                       $FFFF, ; Grab transparence color from sprite pos y - For preset set ..y= the color you want - as sample $FF00FF                 
                                       arc,   ; Rotating degree
    ...
    result=BF(1, Get_animation_buffer_hidden_ID_canvas_BF(), texture_2_ID,
                                 0,   
                                 0,  
                                 100+GetSprite_X_BF(), ; Adjust rotation
                                 GetSprite_Y_BF(),     ; Adjust rotation
