...
;{ Simple Graph }
   ...
   Procedure DrawSimpleGraph (hImgOut, Array GraphData(1), Average, GridStepX = 10, GridStepY = 10, FontSize = 9, Color1 = $00DDDD, Color2 = $DDDD00)
...
CompilerIf #PB_Compiler_IsMainFile
  Define W = 800
  Define H = 600
  Define tImg = CreateImage(#PB_Any, W, H, 32, $405050)
  ...
  DrawSimpleGraph(tImg, GraphValues(), 16, 10, 10, 11)
